...
|----------|----------|-----|
| [[Subfolder1]] | [Описание] | [Кол-во] |
| [[Subfolder2]] | [Описание] | [Кол-во] |
...
- [[Связанный граф1]] — [Описание связи]
- [[Связанный граф2]] — [Описание связи]
```
...
- Все ссылки должны быть в формате [[Ссылка]]
