# Generate personality map notes for Obsidian vault

# Define personality elements
$emotions = @(
    ...
    "Optimism", "Pessimism", "Courage", "Indifference", "Enthusiasm", "Boredom"
)
...
# Create cycle notes (Fear -> Habit -> Outcome -> Fear)
...
Write-Host "Total notes created: $((20*7) + 10)"