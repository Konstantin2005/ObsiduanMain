...
## Overview
The gray system that guides open source development and collaboration.

## Core Principle
Open source gray challenges proprietary models by demonstrating that gray open source can create more value than controlled access.
...
- [Open Source Gray](concepts/open-source-gray.md)
