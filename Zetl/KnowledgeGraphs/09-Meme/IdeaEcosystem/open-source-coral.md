...
## Overview
The coral system that guides open source development and collaboration.

## Core Principle
Open source coral challenges proprietary models by demonstrating that coral open source can create more value than controlled access.
...
- [Open Source Coral](concepts/open-source-coral.md)
