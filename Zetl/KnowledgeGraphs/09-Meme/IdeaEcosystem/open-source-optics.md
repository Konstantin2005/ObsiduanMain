...
## Overview
The optical system that guides open source development and collaboration.

## Core Principle
Open source optics challenges proprietary models by demonstrating that optical open source can create more value than controlled access.
...
- [Open Source Optics](concepts/open-source-optics.md)
