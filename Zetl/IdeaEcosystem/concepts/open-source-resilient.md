...
## Overview
The resilient system that guides open source development and collaboration.

## Core Principle
Open source resilient challenges proprietary models by demonstrating that resilient open source can create more value than controlled access.
...
- [Open Source Resilient](concepts/open-source-resilient.md)
