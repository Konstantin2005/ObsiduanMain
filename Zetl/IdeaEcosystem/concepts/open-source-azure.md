...
## Overview
The azure system that guides open source development and collaboration.

## Core Principle
Open source azure challenges proprietary models by demonstrating that azure open source can create more value than controlled access.
...
- [Open Source Azure](concepts/open-source-azure.md)
