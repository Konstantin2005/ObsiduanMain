...
## Overview
The green system that guides open source development and collaboration.

## Core Principle
Open source green challenges proprietary models by demonstrating that green open source can create more value than controlled access.
...
- [Open Source Green](concepts/open-source-green.md)
