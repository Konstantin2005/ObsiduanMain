...
## Overview
The blue system that guides open source development and collaboration.

## Core Principle
Open source blue challenges proprietary models by demonstrating that blue open source can create more value than controlled access.
...
- [Open Source Blue](concepts/open-source-blue.md)
