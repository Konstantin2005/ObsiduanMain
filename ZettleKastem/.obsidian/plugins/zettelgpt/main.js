...
var require_package = __commonJS({
  "node_modules/openai/package.json"(exports, module2) {
    module2.exports = {
      ...
      _shasum: "1fa35bdf979cbde8453b43f2dd3a7d401ee40866",
      _spec: "openai",
      _where: "/Users/simgeon-u/Desktop/Study/.obsidian/plugins/obsidian-sample-plugin",
      author: {
        name: "OpenAI"
      },
      bugs: {
...
var ZettelGPTSettingsTab = class extends import_obsidian.PluginSettingTab {
  ...
  display() {
    ...
    new import_obsidian.Setting(containerEl).setName("OpenAI API Key").setDesc("Enter your OpenAI API key").addText(
      (text) => text.setPlaceholder("Enter your API key here...").setValue(this.plugin.settings.openAiApiKey).onChange(async (value) => {
...
// main.ts
var ZettelGPT = class extends import_obsidian2.Plugin {
  async onload() {
    ...
    this.addRibbonIcon("file-plus", "Insert Question Template", async () => {
      var _a;
      const currentFile = (_a = this.app.workspace.getActiveViewOfType(import_obsidian2.MarkdownView)) == null ? void 0 : _a.file;
      if (!(currentFile instanceof import_obsidian2.TFile)) {
        new import_obsidian2.Notice("Note not found. click the note and retry \u{1F914}");
  ...
  async generateAnswer() {
    ...
    if (answerFile instanceof import_obsidian2.TFile && recentLeaf instanceof import_obsidian2.WorkspaceLeaf)
      recentLeaf.openFile(answerFile);
    else
      throw new Error("\uB2F5\uBCC0 \uD30C\uC77C\uC774 \uC81C\uB300\uB85C \uC0DD\uC131\uB418\uC9C0 \uC54A\uC558\uAC70\uB098, workspaceleaf \uC0DD\uC131\uC5D0 \uC2E4\uD328\uD588\uC2B5\uB2C8\uB2E4.");
  }
  async getChatGPTAnswer(question) {
    new import_obsidian2.Notice("getChatGPTAnswer start!");
    ...
    new import_obsidian2.Notice("getChatGPTAnswer end!");
    return res.choices[0].message.content;
  }
  // 질문을 넣으면 stream형식으로 answerFile에 append합니다.
  async getChatGPTAnswer2(messages, answerFile) {
    const apiKey = this.settings.openAiApiKey;
    const endpointUrl = "https://api.openai.com/v1/chat/completions";
    const fetchOptions = {
      method: "POST",
  ...
  async parseQuestionFromString(questionContent) {
    const notesRegex = /## 내용:\n([\s\S]*)/;
  ...
  // debug function
  async parseQuestionFromCurrentFile() {
    const { vault } = this.app;
    const activeView = this.app.workspace.getActiveViewOfType(import_obsidian2.MarkdownView);
    if (!activeView) {
      new import_obsidian2.Notice("\uD604\uC7AC \uC9C8\uBB38\uD30C\uC77C\uC774 \uC5F4\uB824\uC788\uC9C0 \uC54A\uC2B5\uB2C8\uB2E4.");
  ...
  async getConversationHistory(inputFile) {
    ...
    const linkFile = this.app.vault.getAbstractFileByPath(`${links[0].link}.md`);
    const ret = await this.getConversationHistory(linkFile);
    return [...ret, {
